...
BUILD		:= Build
INCLUDES	:= Includes Sources/Helpers/Includes Sources/Menu1 Sources/Menu2 Sources/Menu3 Sources/Menu4
SOURCES		:= Sources Sources/Menu1/Sources Sources/Menu2/Sources Sources/Menu3/Sources Sources/Menu4/Sources Sources/Helpers/Sources
...
LIBS		:= -lctrpf -lctru
LIBDIRS		:= $(CURDIR) $(CTRPFLIB) $(CTRULIB) $(PORTLIBS)
